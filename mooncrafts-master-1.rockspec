...
build = {
	type = "builtin",
	modules = {
		["mooncrafts.nginx.access"] = "lib/mooncrafts/nginx/access.lua",
		["mooncrafts.nginx.content"] = "lib/mooncrafts/nginx/content.lua",
		["mooncrafts.nginx.init"] = "lib/mooncrafts/nginx/init.lua",
